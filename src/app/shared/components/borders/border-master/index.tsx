...
export function BorderMaster({ name, rank, img, avatar, username }: Props) {
	return (
		<div
		...
		>
			...
			<img
				...
				src="https://embee-org.github.io/embee-statics/images/borders/master.png"
				alt="Borde rango master"
				width={250}
				height={450}
			/>
			<p
